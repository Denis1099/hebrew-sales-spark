        ...
        <div className="container mx-auto px-2 md:px-8">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1 space-y-12 text-center">
              ...
              <h1 className="text-4xl md:text-[3.5rem] font-extrabold text-primary leading-[1.2] order-2 mb-8">
              ...
              <h2 className="text-2xl font-extrabold order-4 mb-12 max-w-4xl mx-auto px-4">
                בין אם אתם רק מתחילים או בעלי ניסיון רב שנים, שיטה זו תעניק לכם את הכלים לחדד את כישוריכם ולשפר את התוצאות שלכם.
              </h2>
              <p className="text-lg text-text order-5 mb-14 max-w-3xl mx-auto px-6">
