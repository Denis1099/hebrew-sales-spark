...
const Index = () => {
  return (
    <div className="min-h-screen bg-secondary/10 font-noto" dir="rtl">
      {/* Hero Section */}
      <section className="h-screen flex items-start pt-20 relative bg-secondary/10">
        <div className="container mx-auto px-2 md:px-8">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1 space-y-6 text-center">
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold text-primary leading-tight order-2 mb-6">
