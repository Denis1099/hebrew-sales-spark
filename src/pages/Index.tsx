...
const Index = () => {
  return (
    <div className="min-h-screen bg-secondary/10 font-noto" dir="rtl">
      {/* Hero Section */}
      <section className="h-screen flex items-start pt-16 relative bg-secondary/10">
        <div className="container mx-auto px-2 md:px-8">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1 space-y-8 text-center">
              <div className="text-accent text-xl font-bold order-1 mb-8">
                ניר בנימין מציג:
              </div>
              <h1 className="text-4xl md:text-[3.5rem] font-extrabold text-primary leading-[1.2] order-2 mb-6">
                רצים אל עבר אחוזי סגירה גבוהים יותר
              </h1>
              
              <div className="md:hidden order-3 mb-8">
      ...
      <section className="py-16 bg-white/5">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-16 text-primary">התוצאות מדברות בעד עצמן</h2>
          <ResultsSection />
        </div>
      </section>
